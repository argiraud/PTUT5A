...
INSERT INTO "user" (user_id, birth_date, etudiant_number, first_name) VALUES ('6c2f7f77-ad13-4a81-aa18-a2fe2eeedc5d', '2020-11-10', '00000000', 'user');
INSERT INTO "user" (user_id, birth_date, etudiant_number, first_name) VALUES ('8c2d7b7d-28d4-4166-bc75-23ac5ec35d4b', '2020-11-09', '00000001', 'admin');
...
INSERT INTO entity (email, enable, name, password, user_user_id) VALUES ('admin@admin.fr', true, 'admin', '$2a$10$0IDM4UEa31R0z/.rOTZqQunNItIGGLjOkpaWbdlPSkK1vxo2domXO', '8c2d7b7d-28d4-4166-bc75-23ac5ec35d4b');
